...
htmlString += "<div class='form-group'><div class='col-sm-10'><div class='checkbox'><label><input type='radio' name='thought' value='1'>  Yes, a HUMAN associate</label><label><input type='radio' name='thought' value='2'>  No, a BOT as said</label></div></div></div>";
